...
var valores_dados;
var valores_dados_copia;
var repeticiones = [];

// Cargamos dinero de la máquina y el jugador
...
function tirarDado(){
    ...
    var texto = document.getElementById("texto");
        ...
        valores_dados=[d1,d2,d3,d4,d5];
        valores_dados_copia=[d1,d2,d3,d4,d5];
        ...
        for(n=0;n<2;n++)
        {
            ...
            this.CacluloRepeticiones();

            this.CalculoCombinatoria();
...
function CalculoCombinatoria()
{
    ...
    */ 
    ...
    valores_dados=[d6,d7,d8,d9,d10];
    valores_dados_copia=[d6,d7,d8,d9,d10];
