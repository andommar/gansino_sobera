...
document.getElementById("b_dado1").disabled = true;
document.getElementById("b_dado2").disabled = true;
document.getElementById("b_dado3").disabled = true;
document.getElementById("b_dado4").disabled = true;
document.getElementById("b_dado5").disabled = true;
...
function tirarDado(){
    ...
    document.getElementById("tirar_dados").disabled = true;
...
function DadoGuardado(id_boton)
{

    if(id_boton=="b_dado1")
    {
        dados_guardados[0]=d1;
        document.getElementById("b_dado1").disabled = true;
    }
       
    else if(id_boton=="b_dado2")
    {
        dados_guardados[1]=d2;
        document.getElementById("b_dado2").disabled = true;
    }
       
    else if(id_boton=="b_dado3")
    {
        dados_guardados[2]=d3;
        document.getElementById("b_dado3").disabled = true;
    }
       
    else if(id_boton=="b_dado4")
    {
        dados_guardados[3]=d4;
        document.getElementById("b_dado4").disabled = true;
    }
       
    else if(id_boton=="b_dado5")
    {
        dados_guardados[4]=d5;
        document.getElementById("b_dado5").disabled = true;
    }
       

       for(var m=0;m<dados_guardados.length;m++)
       {
           console.log("Posicion:"+[m]+" "+dados_guardados[m]);
       }
}
...
function Continuar()
{
    ...
    document.getElementById("tirar_dados").disabled =false;
    ...
    d10 = Math.floor(Math.random()*6)+1;
            ...
            for (m=0;m<dados_guardados.length;m++)
            {
                if(dados_guardados[m]!=0){
                    valores_dados[m]=dados_guardados[m];
                    valores_dados_copia[m]=valores_dados[m];
                }

            }

            for(var x=0;x<dados_guardados.length;x++)
            {
                console.log(valores_dados[x]);
            }
        ...
        //Pasamos los valores a los dados html
        //Jugador
        die1.innerHTML=valores_dados[0];
        die2.innerHTML=valores_dados[1];
        die3.innerHTML=valores_dados[2];
        die4.innerHTML=valores_dados[3];
        die5.innerHTML=valores_dados[4];
...
function MensajeAlerta(resultado){
    ...
    switch(resultado){
        case 0:
        swal("Has perdido la partida!");
        break;

        default:
        swal("Has ganado la partida!");
